		...
		public class webClient {
		    public static void main(String[] args) throws Exception {
		       ...
		       // System.out.print("please input the ip address and port number : ");
		        ...
		        String se = http.getWebContentByPost("http://192.168.11.215:8192/index.html","","ISO-8859-1", 3000);
		    ...
		    private String sendGet() throws Exception {
		        ...
		        String url = "http://192.168.11.215:8192/index.html";
			...
			connection.setRequestProperty("User-Agent", "1/Paz/WebClient/COMNET"); 
